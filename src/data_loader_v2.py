"""
Data loader module for the Dance Studio Schedule Optimizer (Version 2).

This module contains functions for loading and parsing data from the new
...
def load_data(file_path):
    """
    Load data from the new normalized Excel structure.
